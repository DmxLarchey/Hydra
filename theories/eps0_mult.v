...
Section eps0_multiplication.
  ...
  Proof.
    ...
    + destruct (ord_1add_limit_dec j) as [ G | G ].
  ...
  Proof.
    ...
    + destruct (ord_1add_limit_dec j) as [ Gj | Gj ];
      destruct (ord_1add_limit_dec i) as [ Gi | Gi ].
